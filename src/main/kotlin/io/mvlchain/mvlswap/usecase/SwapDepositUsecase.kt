...
import io.mvlchain.mvlswap.boundary.dto.SwapDepositResponeDto
import io.mvlchain.mvlswap.exception.SwapHistoryNotFoundException
...
class SwapDepositUsecase(private val swapHistoryRepository: SwapHistoryRepository) {
    ...
    fun execute(hash: String): SwapDepositResponeDto {
        ...
        val swapHistory: SwapHistory = swapHistoryRepository.findByRandomNumberHash(hash) ?: throw SwapHistoryNotFoundException(hash)
        ...
        val bep2SenderB32Data = Bech32.decode(swapHistory.senderAddr)
        ...
        val bep2RecipientB32Data = Bech32.decode(swapHistory.receiverAddr)
        val strBep2RecipientB32Data = swapHistory.receiverAddr!!.substring(bep2RecipientB32Data!!.hrp.length)
        ...
        val binanceDexApiNodeClient: BinanceDexApiNodeClient =
            BinanceDexApiClientFactory.newInstance().newNodeRpcClient(
        ...
        var listTxMetadata: List<TransactionMetadata> =
            binanceDexApiNodeClient.htlt(htltReq, wallet, TransactionOption.DEFAULT_INSTANCE, true);
